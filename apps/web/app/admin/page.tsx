    ...
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {adminTabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-md text-sm font-medium transition-all text-left whitespace-nowrap ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card 
            className="p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 relative"
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                {statsLoading ? (
                  <div className="animate-pulse h-8 w-16 bg-gray-200 rounded mt-0"></div>
                ) : (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1 overflow-hidden">
                ...
                {statsLoading ? (
                  <div className="animate-pulse h-8 w-24 bg-gray-200 rounded mt-0"></div>
                ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <ProductPageButton
                variant="outline"
                className="h-9 px-4 text-sm font-semibold text-left whitespace-nowrap [direction:ltr]"
                onClick={() => router.push('/admin/orders')}
              >
        ...
        <Card className="p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            <ProductPageButton
              ...
              className="justify-start w-full h-auto py-4 text-sm text-left [direction:ltr]"
            >
