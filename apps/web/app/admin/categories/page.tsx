...
function CategoriesSection() {
  ...
  const buildCategoryTree = (categories: Category[]): Array<Category & { level: number; children?: Category[] }> => {
    ...
    // Flatten tree for display (use any to avoid deep recursive typing issues)
    const flattenTree = (
      nodes: any[],
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <ProductPageButton
                    variant="outline"
                    className="h-7 px-2 text-[10px] font-medium flex items-center justify-center gap-0.5 !text-blue-600 !border-blue-300 hover:!bg-blue-50 hover:!text-blue-600 hover:!border-blue-300"
